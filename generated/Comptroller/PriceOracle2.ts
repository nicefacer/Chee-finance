...
export class PriceOracle2 extends ethereum.SmartContract {
  ...
  cCeloAddress(): Address {
    let result = super.call("cCeloAddress", "cCeloAddress():(address)", []);

    return result[0].toAddress();
  }

  try_cCeloAddress(): ethereum.CallResult<Address> {
    let result = super.tryCall("cCeloAddress", "cCeloAddress():(address)", []);
    if (result.reverted) {
